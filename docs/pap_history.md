...
## Nachtrag v1.14 (21.09.2026): Ergebnisse der registrierten kontinuierlichen Spezifikation

| Maß, Fenster | θ (pp je SD je Richtungseinheit) | SE (JK) | t | p (Permutation) |
|---|---|---|---|---|
| Einlagenquote, 1 Tag (**Hauptspezifikation**) | 0,051 | 0,056 | 0,92 | 0,47 |
| Sichteinlagenquote, 1 Tag | 0,060 | 0,054 | 1,12 | 0,38 |
| Einlagenquote, 2 Tage | 0,130 | 0,092 | 1,42 | 0,16 |
| Sichteinlagenquote, 2 Tage | 0,075 | 0,084 | 0,90 | 0,42 |
| Einlagenquote, 1 Tag, ohne Crédit Agricole | 0,053 | | 0,94 | |

Alle Koeffizienten haben das vorhergesagte Vorzeichen, keiner ist signifikant. Das 95-%-Intervall der Hauptspezifikation reicht von etwa −0,06 bis +0,16 pp je Standardabweichung. Burlon et al. finden für die Ankündigungen 2020/21 über 1 pp je Standardabweichung der Einlagenquote je Ereignis. Die Obergrenze unseres Intervalls liegt damit bei etwa einem Sechstel dieses Werts.
Permutation mit 999 Ziehungen im Eintages-, 499 im Zweitagesfenster (Rechenzeitgrenze; im Log vermerkt).

---

## Nachtrag v1.15 (21.09.2026): Robustheit, explorative Ereigniszerlegung, Abschluss

- Leave-one-event-out, Hauptspezifikation: θ zwischen −0,005 und 0,153 pp; der obere Wert entsteht beim Weglassen des EZB-Pilotaufrufs vom 05.03.2026.
- Null-imponierter Wild-Cluster-Bootstrap (Rademacher, Firmen): p = 0,34.
- Nur als hoch überraschend vorkodierte Ereignisse (5): θ = 0,014, t = 0,11. Spricht gegen Antizipation als Erklärung.
- Explorativ, nicht registriert: ereignisweise Steigungen. 6 von 10 positiv; vier Ereignisse um 0,4 pp je SD (Okt 2023, Sep 2025, Okt 2025, Nov 2025); 2026 null oder negativ, Pilotaufruf stark negativ. Als explorativ gekennzeichnet.
- Paper: Schlussfolgerung geschrieben, Abstract auf Finanzstabilität zugespitzt, alle Platzhalter entfernt, doppelter Anhangabschnitt entfernt. Übersetzungslauf ohne Fehler, ohne Overfull-Boxen, ohne offene Verweise. 32 Seiten.

---

## Nachtrag v1.16 (21.09.2026): Überarbeitung nach Gutachten

**Korrekturen:**
1. Theorie/Messung: Die Grenzwirkung einer höheren Haltegrenze hängt vom Anteil der Einlagen **oberhalb** der Grenze ab (S'(L) = σ[1−F(L)]); der Text behauptete an drei Stellen das Gegenteil. Korrigiert. Proposition 2 und ihr Beweis korrigiert: Der Niveauabstand ist schwach steigend in L, nicht innen maximal. Die Sichteinlagenquote ist jetzt ausdrücklich ein Proxy für die substituierbare Einlagenbasis, keine direkte Messung der Grenzwirkung.
2. Look-ahead: Die Kodierung des Entwurfs vom 09.02.2024 und der Änderungen vom 21.02.2024 stützte sich teilweise darauf, dass der Entwurf nie abgestimmt wurde. Das ist ex post. Beide werden nun ausgeschlossen statt null kodiert. Ergebnis unverändert: θ = 0,051, p = 0,47.
3. Stichprobenfluss vereinheitlicht (Tabelle): 26 gesammelt → 22 Schätzdaten registriert → 20 ohne Look-ahead; davon 4 Design- und 6 Umsetzungsereignisse mit Bankenrichtung.
4. „complete record" → „complete published record of 309 disclosed meetings".

**Nicht registrierte Zusatzanalysen, ausgewiesen neben dem registrierten Ergebnis:**
- Nur Designparameter-Ereignisse: θ = −0,004 pp (p = 0,97, 4 Ereignisse). Umsetzungsereignisse: 0,096 (t = 0,95).
- Placebo Nicht-Euro-Banken (4 mit EBA-Daten): Steigung 0,182 (t = 1,10), größer als bei Euro-Banken; Differenz −0,131.

**Offen und offen benannt:** zeitstempelgenaue Ereignistage (Zweitagesfenster als Absicherung), zweiter Kodierer (Blattvorlage in `docs/second_coder_sheet.csv`).

**Literatur:** von 4 auf 19 Einträge, jeweils im Text verankert.

---

## Nachtrag v1.17 (21.09.2026): Frühe Ereignisse 2020/21, Kodierung vor den Renditen eingefroren

Sechs Ereignisse, verifiziert an EZB-Pressemitteilungen und am Arbeitspapier von Burlon et al.: Bericht (02.10.2020), Konsultationsstart (12.10.2020), Konsultationsende (13.01.2021), Rede mit Haltegrenze von rund 3.000 Euro (10.02.2021), Konsultationsergebnisse (14.04.2021), Start der Untersuchungsphase (14.07.2021). Bankenrichtung: −1 für Bericht und Untersuchungsphase (Umsetzung), +1 für die Haltegrenzen-Rede (Design), 0 für die drei Konsultationsschritte. Kodierung per Hash eingefroren, bevor eine Rendite aus `prices_2019_2021.csv` berechnet wurde.

**Test (vorab festgelegt):** Dieselbe Spezifikation wie die Hauptschätzung, Exposition = Einlagenquote, Eintagesfenster. Hypothese der Deutung „2021 bepreist": θ_früh deutlich größer als θ_spät; gepoolte Schätzung mit Interaktion Früh × Exposition × Richtung.
**Bekannte Einschränkung:** Die Exposition stammt vom 31.03.2023 und ist für 2020/21 damit nicht vorbestimmt. Einlagenquoten sind hoch persistent; das wird offen benannt.

---

## Nachtrag v1.18 (21.09.2026): Ergebnis der frühen Ereignisse

Vorab festgelegter Test (v1.17): θ_früh = −0,243 pp je SD, t = −1,19, Permutations-p = 0,20. **Die Deutung „die Haltegrenze wurde 2021 bepreist" wird damit nicht gestützt.**

Ereignisweise (explorativ):
- Bericht 02.10.2020 (Richtung −1): signierte Steigung **+1,06 pp je SD** (SE 0,35). Vorhergesagtes Vorzeichen, Größenordnung wie bei Burlon et al.
- Haltegrenzen-Rede 10.02.2021 (Richtung +1): **−1,21** (SE 0,33). Gegenvorzeichen.
- Untersuchungsphase 14.07.2021 (−1): −0,05.

Lesart: Das Design erkennt Effekte der Burlon-Größenordnung, wenn es sie gibt (Bericht 2020, Positivkontrolle). Nachrichten über das Ob der Einführung wurden 2020 bepreist; Nachrichten über das Design weder 2021 noch 2023–26. Die frühere Deutung wird im Paper entsprechend revidiert.
- Paper: Abschnitt „Extending the sample to 2020 and 2021" ergänzt; die frühere Deutung („2021 bepreist") ist als getestet und nicht gestützt ausgewiesen; neue Lesart: Existenznachricht 2020 bepreist, Designnachrichten nie. Kombinierte Abbildung 2020–2026. Abstract auf 154 Wörter gekürzt. Auf Wunsch des Autors keine Aussage zur zweiten Kodierung im Paper.

## Nachtrag v1.19 (21.09.2026): Zeitliche Ausrichtung und Störnachrichten
Vorab aus den dokumentierten Veröffentlichungsumständen festgelegt: Europäischer Rat 23.10.2025 (Schlussfolgerungen am Ende des Gipfels; am selben Morgen 19. Russland-Sanktionspaket) auf den nächsten Handelstag verschoben → θ = 0,011 (t 0,20). Beide Tage mit großer Störnachricht (23.10.2025; 19.12.2025, Gipfel zu MFR, Erweiterung, Ukraine) ausgeschlossen → θ = −0,005 (t −0,09). Beide Prüfungen schieben den Schätzer gegen null. Einleitung um Ergebnis- und Bedeutungsabsätze ergänzt.

## Nachtrag v1.20 (21.09.2026): Dritte Gutachtenrunde
- Ereigniszahlen harmonisiert: 26 gesammelt, 24 verifiziert, 22 Schätzdaten registriert.
- Überzeichnung reduziert: „priced existence, not design" → „appear to have reacted to early existence news; no comparable response to later design news". „zero" → „no detectable price effect", mit KI [−0,22; 0,21] für die vier Designereignisse.
- Modell: Anbieterrente enthält jetzt den Zugangsterm a·ρ_j·r·V^mobile; Proposition 5 trennt Gatekeeper-Verlust (aus dem Modell) und Anbietergewinn (Annahme über ρ_j).
- Restfehler „small balances" in 9.5 korrigiert.
- Permutation: Austauschbarkeitsannahme benannt; nach Land geblockte Permutation p = 0,45 (10 Länder); Exposition auf Land residualisiert θ = 0,011 (t 0,23).
- Romano-Wolf über die drei Gruppenvorhersagen (Placebo-Daten-Resampling): p_adj 0,88 / 0,88 / 0,85.
- Abweichung dokumentiert: kontinuierliche Anbieterexposition (Umsatzanteile) nicht erhoben.
- Offen: historische Exposition 2019/2020 für die frühen Ereignisse (EBA-Übung 2020), vollständige Zeitstempel.

## Nachtrag v1.21 (21.09.2026): Historische Exposition, vor der Schätzung festgelegt
EBA-Übung Frühjahr 2020, Stichtag 31.12.2019. Codes geprüft: identisch zu 2023 (Instrument 30 = Einlagen, 31 = Sichteinlagen; Sektor 301 = NFC, 401 = Haushalte; Positionen 2021214 = Gesamtverbindlichkeiten, 2021215 = nach Sektor/Instrument). Maß wie registriert: (Einlagen 401 + 301) / Gesamtverbindlichkeiten, standardisiert über die Euro-Banken. Ersetzt die 2023-Exposition **nur** für die Ereignisse 2020/21; Spezifikation sonst unverändert. Festgelegt vor jeder Schätzung mit diesem Maß.
Ergebnis v1.21: θ_früh = −0,267 pp je SD (t −1,47, p_perm 0,17). Berichtstag 02.10.2020: +0,85 (SE 0,37); Grenzsignal 10.02.2021: −1,09 (SE 0,34); Untersuchungsphase: −0,06. Korrelation der Expositionen 2019/2023: 0,97. Die Positivkontrolle hält mit vorbestimmter Exposition.

## Nachtrag v1.22 (21.09.2026): Vierte Gutachtenrunde
- Design-only Power (tatsächliche Struktur, 4 Ereignisse, 29 Banken, empirische Streuung): Power 0,54 / 0,77 / 0,90 bei 0,4 / 0,5 / 0,6 pp je SD; Size 0,07. Ereignisweise Steigungen: +0,36, +0,42, −0,24, −0,10.
- Vollständige Zeitklassifikation aller 22 Schätzdaten (`data/hand/event_timing.csv`): 8 während des Handels, 1 nach Schluss, 13 unbekannt (Zweitagesfenster). Ergebnis: θ = 0,161 (t 1,82); ohne Störtage 0,155 (t 1,94); nur Design 0,168 (t 1,09). **Der Punktschätzer steigt**, die Schranke bleibt (obere KI-Grenze ≈ 0,33). Im Paper offen berichtet, einschließlich dass dies der Lesart „alles schiebt gegen null" widerspricht.
- Untertitel auf Banken zugespitzt („Bank Valuations and the Legislative Design of the Digital Euro"); Abstract mit „post-registered"-Markierung und zeitausgerichtetem Schätzer; Nichtbanken-Evidenz als schwächer benannt.
- Zweite Kodierung: auf Wunsch des Autors nicht durchgeführt.

## Nachtrag v1.23 (21.09.2026): Fünfte Gutachtenrunde, Einfrieren
- Zeitausgerichtete Spezifikation mit voller Inferenz: θ = 0,161, SE 0,088, 95-%-KI [−0,01; 0,33], Permutations-p 0,068, Wild-Bootstrap-p 0,045. **Schwache Evidenz für einen kleinen Effekt**; im Abstract und in der Einleitung so benannt.
- Formulierung „aligning each event to its publication time" → „conservative release-time alignment, two-day windows where publication time is unknown". Behauptung „released with a timestamp" in 2.5 korrigiert.
- Widerspruch zur Anbieterexposition im Datenteil bereinigt („planned measure … not implemented").
- Zweite Kodierung: auf Wunsch des Autors nicht durchgeführt.
- Paper eingefroren.

## Nachtrag v1.24 (21.09.2026): Sechste Gutachtenrunde
Formulierungen gemildert: Nicht-Euro-Placebo „consistent with a generic factor" statt „marks"; „no material deposit-flight risk at any stage" → „no large residual deposit-flight risk; any effect appears modest relative to the early announcements"; „did not move bank valuations" → „moved little, if at all". Einleitung beginnt jetzt mit dem Finanzstabilitätsmotiv (Einlagenflucht, Haltegrenze als Schutz). Einreichungstext für den Call erstellt.

## Nachtrag v1.25 (21.09.2026): Redaktionelle Endkorrektur
Kaputter Verweis („Section efsec:continuous") repariert; veralteter Satz zum Datum des Berichterstatter-Papiers ersetzt; Anhangtabelle 8 neu erzeugt (vollständiger Inhalt, keine abgeschnittenen Zellen, Status als „Coded" / „Excluded: …"); Anhang D.3 an den Haupttext angeglichen (Anbieter- und Konzentrationsmaß nicht erhoben); Abbildung 3B mit Hinweis auf die Regression nur mit Bankenterm (0,118 gegenüber 0,101 in der Vollspezifikation); „small-balance share" entfernt; Chiu et al. mit Seiten 1213–1248; Status der vorab geplanten Heterogenitätssplits offen benannt; PDF-Titelmetadaten bereinigt.

## Nachtrag v1.26 (21.09.2026): Siebte Durchsicht, Endfassung für den Call
Terminologie: „registered" → „pre-specified" (kein externes Register; lokaler, datierter Hash-Freeze), Anhang E jetzt „Pre-specification and deviations" mit vollständiger Abweichungstabelle (geplant / umgesetzt / Grund / Zeitpunkt). Abstract: „22 verified event dates in the pre-specified estimation sample". E04/E06 in Tabelle 8: „Zero in pre-specified sample; excluded without look-ahead". Anhang D.2: Stichprobenregel je Firma-Ereignis statt „listed throughout". Anhang D.3: „All implemented exposure measures". Schlussrhetorik präzisiert. 40 Seiten.

## Nachtrag v1.27 (21.09.2026): Konsistenzkorrekturen
Titelfußnote an Anhang E angeglichen; Kodierregel mit Ausnahme der Februar-2024-Ereignisse; Abstract „available design content"; F5 auf ein Ereignis; Konzentrationsmaß als geplant und nicht erhoben; Abweichungstabelle: Rollensplit mit korrektem Grund, Pilot-Innengruppentest als eigene Zeile.

## Nachtrag v1.28 (21.09.2026): Achte Durchsicht
- Proposition 1: 1−F(L) korrekt als Anteil der Einleger mit Guthaben über L interpretiert (nicht Anteil des Einlagenvolumens); alle Folgestellen angepasst.
- Firmenkanal formalisiert: Π^B = s[D − S(L) − λC] + φ; ∂Π^B/∂λ = −sC ≤ 0; Beweis angepasst.
- Versprochene Robustheit nachgereicht (Tabelle im Anhang): Dreitagesfenster −0,006; Schätzfenster 120/500 Tage 0,061/0,050; ohne März-2023-Turbulenzen 0,051 (identisch, da gemeinsames Schätzfenster danach liegt; offengelegt); Marktmodell STOXX 0,055; **Schätzfenster je Ereignis [−260,−11]: 0,099 (t 1,83)**; F3 begrenzende Ereignisse 0,005, ausweitende 0,096. Vierfaktormodell nicht geschätzt (Bankenindex nicht beschaffbar) → Abweichungstabelle.
- Gemeinsames Schätzfenster im Strategieteil offengelegt.
- Zeitform korrigiert (geplante, nicht umgesetzte Splits); Gerätekanal „access event"; Tabelle 8 umbenannt.

## Nachtrag v1.29 (21.09.2026): Neunte Durchsicht, Rechenfehler gefunden und behoben
- **Währung:** Die europäischen FF-Faktoren sind in USD, die Renditen in Landeswährung. Zusätzlicher währungskonsistenter erster Schritt (Marktfaktor = STOXX 600 in EUR, SMB/HML beibehalten): 0,042 / 0,115 / 0,147 / −0,003 (ein Tag / zwei Tage / zeitausgerichtet / Design). Alles leicht Richtung null, keine Schlussfolgerung ändert sich. Rohrenditen vs. Überschussrenditen: nur Intercept betroffen, offengelegt.
- **Rechenfehler:** Zweitagesfenster summierten über vorhandene Tage (min_count=1). Korrigiert (beide Tage verlangt). Beobachtungen 1.069 → 1.032; Anbieter zwei Tage −0,51 → −0,29 (t −0,94); Banken 0,186 (t 0,82); Gerätehersteller 1,40 (t 1,60). Kontinuierlich zwei Tage 0,131 (p 0,15).
- **Zeitausgerichtet neu gerechnet:** θ = 0,161, SE 0,089, KI [−0,01; 0,33], Permutations-p 0,081 (999), Wild-Bootstrap-p 0,064. Die frühere Angabe p_wild = 0,045 entfällt; nicht mehr signifikant auf 5 %.
- Text: Schluss („magnitude bound survives", „no consistent or detectable response"), F2 als geplant und nicht identifiziert, Größenangabe „assess finite-sample size by simulation", Zeitformulierung, „co-legislators adopted and narrowed their positions", Beitrag „first event-study use of the legislative process", Tabellennote mit Ausnahme der Februar-2024-Ereignisse, Schätzfenster ausdrücklich als nicht rein vorab benannt.

## Nachtrag v1.30 (21.09.2026): Zehnte Durchsicht
- Positivkontrolle mit strikt vorab geschätzten Betas: Berichtstag 0,77 (SE 0,36, FF3) bzw. 0,82 (0,37, EUR-Marktmodell in Überschussrenditen); Grenzsignal −1,09. Hält.
- Vollständig EUR-denominiertes Marktmodell in Überschussrenditen (risikofrei = EZB-Einlagesatz): ein Tag 0,054 (t 0,95); Design −0,001; **zeitausgerichtet 0,167, SE 0,082, KI [0,01; 0,33], Permutations-p 0,064, Wild-p 0,028**. Offen berichtet: unter der saubersten Währungsbehandlung auf 5 % signifikant nach Bootstrap, knapp nicht nach Permutation. Abstract, Einleitung, Schluss angepasst („some evidence of a small effect, not robust").
- „Currency-consistent three factors" umbenannt in „EUR market factor with FF size and value".
- Ratsposition: Satz „describes exactly" entfernt; gegenläufige Anbieterkanäle benannt; Sensitivität Anbieterrichtung = 0: −0,38 (t −1,16).
- Kleine Formulierungen: Faktormodelle je Börsenplatz, Sichteinlagen als Proxy, Heimatland „addressed through".

## Nachtrag v1.31 (21.09.2026): Titel geändert, finale Formatierung
Untertitel: „Bank Valuations in the Digital Euro Legislative Process" (Titelseite und PDF-Metadaten). Schmale Tabellenspalten flatternd gesetzt (keine Underfull-Boxen mehr). Schluss um drei redundante Sätze gekürzt, damit er nicht mit drei Zeilen auf eine eigene Seite läuft. Endkontrolle: 0 Fehler, 0 offene Verweise, 0 Overfull, 0 Underfull, A4, alle Schriften eingebettet, 42 Seiten.

## Nachtrag v1.32 (21.09.2026): Layout nach Autorenwunsch
Titelfußnote entfernt; kein Kopfzeilentitel; Seitenzahl unten rechts; Titelseite ohne Zahl, Einleitung = Seite 1; Absatzeinzug 1,2 em; Aufzählungen mit schmalerem Einzug und bündigen Folgezeilen; Parameterliste ohne in den Rand ragende Marken; Abstand nach Absatzüberschriften verringert; Text nach Listen ohne Einzug fortgesetzt.

## Nachtrag v1.33 (21.09.2026): Abbildungen und Literatur
- Abbildung 1 neu: Ereignisse in zeitlicher Reihenfolge statt Zeitachse (keine Überlappungen), Panel A Richtung je Gruppe als ▲/▼, Panel B Treffen in den 30 Tagen davor. Lobbyabbildung mit sauberen Jahresachsen und frei stehenden Beschriftungen. Alle vier Abbildungen auf Textbreite erzeugt (lesbare Schriftgröße), Anmerkungen aus dem Bild in LaTeX unter die Abbildung verschoben.
- Literatur um fünf geprüfte Titel zum digitalen Euro ergänzt (Meller & Soons 2023; Lambert et al. 2024; Muñoz & Soons 2023; Auer et al. 2025; Chapman et al. 2023), jeweils im Text verankert; Meller & Soons zusätzlich als Einordnung des Ergebnisses (Grenzen der Verhandlung liegen unter ihrer Schwelle von 5.000 Euro). 24 Einträge.
